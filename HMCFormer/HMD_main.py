...
if __name__ == "__main__":
    ...
    print("all Starting")
    main(Parameters([0, 1, 4, 800, 1e-4, 0.1, [280, 200, 10], 128, 512, 20, 4, 6, 6, 6, 'relu', 'cls', 1e-7, 1e-3,
         0.02, 0.3, True, False, 1., 0.1, 6, False, 'GRAPHORMER', 'BCE', 'EncoderLayer', f'VeReMi_HMC_all',
                     'VeReMi', range(0, 6)]))
    print("all Ended")
    print("neg Starting")
    main(Parameters([0, 1, 4, 800, 1e-4, 0.1, [300, 200, 10], 128, 512, 20, 4, 6, 6, 6, 'relu', 'cls', 1e-7, 1e-3,
         0.02, 0.3, True, False, 1., 0.1, 6, False, 'GRAPHORMER', 'BCE', 'EncoderLayer', f'VeReMi_HMC_neg',
                     'VeReMi', range(1, 6)]))
    print("neg Ended")

    # print("ce+rdrop Starting")
    # main(Parameters([0, 1, 4, 600, 1e-4, 0.1, [250, 200, 10], 128, 512, 20, 4, 6, 6, 6, 'relu', 'cls', 1e-7, 1e-3,
    #                 0.02, 0.3, True, False, 1., 0.1, 6, False, '', 'BCE', 'EncoderLayer', f'VeReMi_ce+rdrop245+beta{beta}',
    #                 'VeReMi', [2, 4, 5]]))
    # print("ce+rdrop Ended")

    # print("base_line Starting")
    # main(Parameters([0, 1, 4, 600, 1e-4, 0.1, [300, 200, 10], 128, 512, 20, 4, 6, 6, 6, 'relu', 'cls', 1e-7, 1e-3,
    #      0.02, 0.3, False, False, 1., 0.2, 6, False, '', 'BCE', 'EncoderLayer', f'VeReMi_ce+graph',
    #                  'VeReMi', [2, 4, 5]]))
    # print("base_line Ended")
    #
    # print("ce+graph Starting")
    # main(Parameters([0, 1, 4, 600, 1e-4, 0.1, [300, 200, 10], 128, 512, 20, 4, 6, 6, 6, 'relu', 'cls', 1e-7, 1e-3,
    #      0.02, 0.3, False, False, 1., 0.2, 6, False, 'GRAPHORMER', 'BCE', 'EncoderLayer', f'VeReMi_ce+graph',
    #                  'VeReMi', [2, 4, 5]]))
    # print("ce+graph Ended")
    #
    # print("ce+rdrop+graph Starting")
    # main(Parameters([0, 1, 4, 1200, 1e-4, 0.1, [300, 200, 10], 128, 512, 20, 4, 6, 6, 6, 'relu', 'cls', 1e-7, 1e-3,
    #      0.02, 0.3, True, False, 1., 0.2, 6, False, 'GRAPHORMER', 'BCE', 'EncoderLayer', f'VeReMi_HMC',
    #                  'VeReMi', [2, 4, 5]]))
