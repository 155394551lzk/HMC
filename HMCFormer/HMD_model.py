...
if __name__ == "__main__":
    ...
    # main(Parameters([0, 1, 4, 600, 1e-4, 0.1, [250, 200, 10], 128, 512, 20, 4, 6, 6, 6, 'relu', 'cls', 1e-7, 1e-3,
    #                 0.02, 0.3, True, False, 1., 0.2, 6, False, '', 'BCE', 'EncoderLayer', f'VeReMi_ce+rdrop245+beta0.2',
    #                 'VeReMi', [2, 4, 5]]))
    # print("ce+rdrop Ended")

    # print("ce+rdrop+graph Starting")
    # main(Parameters([0, 1, 4, 1200, 1e-4, 0.1, [300, 200, 10], 128, 512, 20, 4, 6, 6, 6, 'relu', 'cls', 1e-7, 1e-3,
    #      0.02, 0.3, True, False, 1., 0.1, 6, False, 'GRAPHORMER', 'BCE', 'EncoderLayer', f'VeReMi_HMC',
    #                  'VeReMi', [2, 4, 5]]))
    # print("ce+rdrop+graph Ended")
    # for model in ['GAT', 'GCN', ]:
    #     print(f"ce+rdrop+{model} Starting")
    #     main(Parameters([0, 1, 4, 600, 1e-4, 0.1, [300, 200, 10], 128, 512, 20, 4, 6, 6, 6, 'relu', 'cls', 1e-7, 1e-3,
    #          0.02, 0.3, True, False, 1., 0.2, 6, False, model, 'BCE', 'EncoderLayer', f'VeReMi_{model}',
    #                      'VeReMi', [2, 4, 5]]))
    #     print(f"ce+rdrop+{model} Ended")

    # for model in ['CNN', 'LSTM', 'CNN_LSTM']:
    #     print(f"ce+rdrop+{model} Starting")
    #     main(Parameters([0, 1, 4, 600, 1e-4, 0.1, [300, 200, 10], 128, 512, 20, 4, 6, 6, 6, 'relu', 'cls', 1e-7, 1e-3,
    #          0.02, 0.3, True, False, 1., 0.2, 6, False, 'GRAPHORMER', 'BCE', model, f'VeReMi_{model}',
    #                      'VeReMi', [2, 4, 5]]))
    #     print(f"ce+rdrop+{model} Ended")

    for beta in [1, 2, 4]:
        print(f"HMC+beta{beta} Starting")
        main(Parameters([0, 1, 4, 800, 1e-4, 0.1, [300, 200, 10], 128, 512, 20, 4, 6, 6, 6, 'relu', 'cls', 1e-7, 1e-3,
                         0.02, 0.3, True, False, 1, beta, 6, False, 'GRAPHORMER', 'BCE', 'EncoderLayer', f'VeReMi_beta{beta}',
                         'VeReMi', [2, 4, 5]]))
        print(f"HMC+beta{beta} Ended")

    for alpha in [0.1, 0.2, 0.5, 1, 2, 4]:
        print(f"HMC+alpha{alpha} Starting")
        main(Parameters([0, 1, 4, 800, 1e-4, 0.1, [300, 200, 10], 128, 512, 20, 4, 6, 6, 6, 'relu', 'cls', 1e-7, 1e-3,
                         0.02, 0.3, True, False, alpha, 0.1, 6, False, 'GRAPHORMER', 'BCE', 'EncoderLayer', f'VeReMi_alpha{alpha}',
                         'VeReMi', [2, 4, 5]]))
        print(f"HMC+alpha{alpha} Ended")
